    ...
    <div id="experience" className="relative py-20">
      ...
      >
        {experienceData.map((data, i) => (
          <div
            key={`id-${i}`}
            className={`w-[600px] max-xl:w-[480px] max-sm:w-full px-12 max-sm:px-0 relative -left-[300p ${
              i % 2 === 0
          ...
          >
            <motion.div
              ...
              className="relative flex flex-col gap-y-3 rounded-md border border-red-300 bg-white p-4 tracking-wide max-sm:text-sm dark:bg-zinc-700 transition-colors z-20"
            >
              <h1 className="text-xl max-sm:text-lg font-light text-gray-700 dark:text-white">
                {data.title}
              </h1>
              ...
              <span
                className={`absolute top-20 text-red-300 -translate-y-1/2 max-lg:hidden ${
